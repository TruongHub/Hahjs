spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> Welcome To Truong Hub <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join Truong's Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
do
    Tabs.Discord:AddButton(
        {
            Title = "Discord Trường Hub",
            Description = "https://discord.com/invite/NAkXzkwY",
            Callback = function()
                setclipboard("https://discord.com/invite/NAkXzkwY")
                Fluent:Notify(
                    {
                        Title = "Truong Hub",
                        Content = "Copied!",
    ...
    _G.FastAttackTruong_Mode = Value
	if _G.FastAttackTruong_Mode == "Fast Attack" then
		_G.Fast_Delay = 0.17
	elseif _G.FastAttackTruong_Mode == "Normal Attack" then
		_G.Fast_Delay = 0.25
	elseif _G.FastAttackTruong_Mode == "Super Fast Attack" then
		_G.Fast_Delay = 0.05
	end
end)
